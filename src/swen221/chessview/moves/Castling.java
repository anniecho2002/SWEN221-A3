...
/**
 *
 * Represents the castling move in chess. This is a multipiece move because it
 * involves both the king and the rook. There are two variations of this move:
 * one where the move occurs on the left of the king, and one where it occurs on
...
public class Castling implements MultiPieceMove {
	 ...
	 * @param kingSide Flag indicates whether move is on kingside or not.
	 */
